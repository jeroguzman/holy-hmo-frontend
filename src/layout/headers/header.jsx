...
const HeaderTwo = () => {
   ...
   return (
    ...
    <header className="header_white_area d-none d-xl-block">
      ...
      <div className="header-menu-area" id="header-sticky">
         <div className="container">
            <div className="row">
   ...
   <div id="header-mob-sticky" className="mobile-header-area mob-white-sticky d-xl-none">
      <div className="container">
         <div className="row align-items-center">
            ...
            <div className="col-md-6 col-7 d-flex align-items-center justify-content-end mt-4">
